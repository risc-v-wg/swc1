...
# Ether Pmod pins JA version (SLOW)
## Pmod pins JA for SPI ether
## JA1 cs G13 out RGB[1]
## JA2 sck B11 out RGB[2]
## JA3 MOSI A11 in init_qspi_cmd
## JA4 MISO D12 out RGB[0]
## JA7 INT D13 in interrupt_0

# Pmod pins JB for SPI ether
# JB1_P CS E15 out RGB[1] -> GPIO[0]
# JB1_N MOSI E16 out RGB[2]
# JB2_P MISO D15 in init_qspicmd
# JB2_N SCK C15 out RGB[0]
# JB3_P INT J17 in interrupt_0
...
set_property PACKAGE_PIN E16 [get_ports {rgb_led[2]}]
# set_property PACKAGE_PIN E15 [get_ports {rgb_led[1]}]
set_property PACKAGE_PIN F6 [get_ports {rgb_led[1]}]
set_property PACKAGE_PIN C15 [get_ports {rgb_led[0]}]
...
set_property PACKAGE_PIN J17 [get_ports interrupt_0]
...
set_property PACKAGE_PIN D15 [get_ports init_qspicmd]
...
set_property PACKAGE_PIN E15 [get_ports {gpio[0]}]
