...
addi x3, x3, 1;
sw x3, 0x4(x5) ; store value A to (0x4000)
addi x3, x3, 1;
sw x3, 0x8(x5) ; store value A to (0x4000)
addi x3, x3, 1;
sw x3, 0xc(x5) ; store value A to (0x4000)
lw x7, 0x0(x5) ; load A
lw x9, 0x4(x5) ; load A
lw x11, 0x8(x5) ; load A
lw x13, 0xc(x5) ; load A

sw x4, 0x0(x6) ; store value B to (0x8000)
addi x4, x4, 1;
sw x4, 0x4(x6) ; store value B to (0x8000)
addi x4, x4, 1;
sw x4, 0x8(x6) ; store value B to (0x8000)
addi x4, x4, 1;
sw x4, 0xc(x6) ; store value B to (0x8000)
lw x8, 0x0(x6) ; load B
lw x10, 0x4(x6) ; load B
lw x12, 0x8(x6) ; load B
lw x14, 0xc(x6) ; load B
